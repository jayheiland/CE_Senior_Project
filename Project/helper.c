...
/*
DAC_setup
Initializes the DAC1 peripheral.
This must be called before the DAC1 can be used
...
/*
TIM2_setup
Initializes the TIM2 peripheral to trigger an interupt at 14285.7Hz

This corresponds to a 446.4 Hz triangle wave
*/
void TIM2_setup() {
